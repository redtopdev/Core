...
namespace Engaze.Core.Web
{
    ...
    public class RequestResponseLoggingMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            logger.LogInformation("Incoming Request {@requestBody}", Encoding.UTF8.GetString(buffer));
            ...
            logger.LogInformation("Outgoing Response {@response}", await streamReader.ReadToEndAsync());
